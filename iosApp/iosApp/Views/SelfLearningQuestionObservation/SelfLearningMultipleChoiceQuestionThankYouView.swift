...
struct SelfLearningMultipleChoiceQuestionThankYouView: View {
    ...
    var body: some View {
            ...
            .customNavigationTitle(with: NavigationScreen.selfLearningQuestionObservation.localize(useTable: navigationStrings, withComment: "Thank you for answering the Question Observation"), displayMode: .inline)
        }
    }
