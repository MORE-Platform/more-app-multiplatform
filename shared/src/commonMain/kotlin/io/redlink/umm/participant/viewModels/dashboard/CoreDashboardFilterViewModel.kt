 ...
 */
package io.redlink.umm.participant.viewModels.dashboard
...
import io.redlink.umm.participant.models.DateFilter
...
class CoreDashboardFilterViewModel(repository: MainRepository) : CoreViewModel() {
    ...
    init {
        Scope.launch {
            repository.observation.observationTypes().firstOrNull()?.let {
