...
data class FcmNotificationConfig(
    ...
    @SerialName(value = "projectId") val projectId: String? = null,

    /* The Google App ID that is used to uniquely identify an instance of an app. */
    @SerialName(value = "applicationId") val applicationId: String? = null,

    @SerialName(value = "apiKey") val apiKey: String? = null,

    @SerialName(value = "databaseUrl") val databaseUrl: String? = null,

    /* The Project Number from the Google Developer's console */
    @SerialName(value = "gcmSenderId") val gcmSenderId: String? = null,

    @SerialName(value = "storageBucket") val storageBucket: String? = null
