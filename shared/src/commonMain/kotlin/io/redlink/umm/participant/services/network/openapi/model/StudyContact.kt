...
data class StudyContact(
    ...
    @SerialName(value = "institute") val institute: String? = null,

    @SerialName(value = "person") val person: String? = null,

    @SerialName(value = "email") val email: String? = null,

    @SerialName(value = "phoneNumber") val phoneNumber: String? = null,
