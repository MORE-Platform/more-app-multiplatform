...
data class StudyConsent(
    ...
    @SerialName(value = "consent") @Required val consent: Boolean = false,

    /* Identifier of the device used to provide consent */
    @SerialName(value = "deviceId") @Required val deviceId: String,

    /* MD5-Hash of the `consentInfo` (text) the participant actually gave consent.  */
    @SerialName(value = "consentInfoMD5") @Required val consentInfoMD5: String,

    @SerialName(value = "observations") @Required val observations: List<ObservationConsent>
