...
class ObservationDataRepositoryImpl(private val appDatabase: AppDatabase) :
    ObservationDataRepository {
    ...
    override suspend fun getCount(): Int = appDatabase.observationDataDao().getCount()
