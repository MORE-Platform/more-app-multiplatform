...
class NetworkServiceImpl(
    ...
    override fun baseUrl() = networkClients.baseUrl()
    ...
    override fun getBasicAuthHeader(): String? = networkClients.basicAuthHeader()

    override fun getGarminSSOUrl(): Url? {
        try {
    ...
    override fun garminSSOCallbackUrl(): Url? {
