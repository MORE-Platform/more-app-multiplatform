 ...
 */
package io.redlink.umm.blendedcare.app.android.activities.setting.leave_study
...
import io.redlink.umm.blendedcare.app.android.activities.leaveStudy.LeaveStudyViewModel
...
import io.redlink.umm.blendedcare.app.android.shared_composables.SmallTitle
import io.redlink.umm.blendedcare.app.android.shared_composables.Title
import io.redlink.umm.blendedcare.app.android.theme.MoreColors
import io.redlink.umm.blendedcare.app.android.theme.moreApproved
...
fun LeaveStudyConfirmView(navController: NavController) {
    ...
    val route =
        backStackEntry?.arguments?.getString(NavigationScreen.LEAVE_STUDY_CONFIRM.routeWithParameters())
