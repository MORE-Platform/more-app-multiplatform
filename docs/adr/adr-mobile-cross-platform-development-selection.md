...
|---------------------------------------------|-------------------------------------------|-------------------------------------------------------------------|-----------------------------------------------------|---------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|
| Technical access to sensor                  | Yes                                       | Yes                                                               | Limited (Accelerometer, Gyroscope, Magnetometer)         | Limited (Accelerometer, Gyroscope, Magnetometer)                                                       | Yes                                                                                               | [No Bluetooth on iOS](https://developer.mozilla.org/en-US/docs/Web/API/Web_Bluetooth_API) :stop_sign: , <br/> Accelerometer, Gyroscope and GPS available |
...
| Notifications                               | Yes                                       | Yes                                                               | Yes                                                 | Yes                                                                                               | Yes                                                                                               | Not supported on iOS :stop_sign:                                                                                                                      |
